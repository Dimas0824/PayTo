...
import {
    ...
    TrendingUp, BarChart3, Star, CreditCard, Box, Users
} from 'lucide-react';
        ...
        <footer className="bg-white pt-24 pb-12 px-6 border-t border-slate-100">
            <div ref={ref} className={`max-w-5xl mx-auto text-center relative z-10 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link href="/login" className="px-10 py-4 bg-indigo-600 text-white rounded-2xl font-bold text-lg hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 hover:shadow-2xl hover:-translate-y-1">
